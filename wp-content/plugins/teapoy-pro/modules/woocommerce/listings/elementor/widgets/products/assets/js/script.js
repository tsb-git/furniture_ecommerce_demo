(function($) {
    ...
    var wdtShopProducts = function($scope, $) {
        ...
        const $carouselprogressbar = $carouselItem.data('carouselprogressbar');
        ...
        if ($scope.hasClass('elementor-element-edit-mode')) {
            ...
            var customCSS = jQuery('body', parent.document).find('style[id="teapoy-woo-non-archive-inline-css"]').text();
            jQuery('body', parent.document).find('style[id="teapoy-woo-non-archive-inline-css"]').remove();
            ...
            var customJS = jQuery('body', parent.document).find('script[id="teapoy-woo-non-archive-js-after"]').text();
            jQuery('body', parent.document).find('script[id="teapoy-woo-non-archive-js-after"]').remove();
